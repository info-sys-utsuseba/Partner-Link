...
export const KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer:
      "入金が確認できた時点で報酬発生条件達成となり、月末締めで請求書をご発行いただく流れでございます。助成金対象外（雇用保険非加入など）の場合は通常契約となり、費用は 1 名 40 万円×人数分をクライアント様にて先行ご負担いただきます。詳細は事業パートナー様用ポータルをご参照ください。",
  ...
  },
  {
    ...
    answer:
      "入金完了で紹介報酬発生となりますので、月末締めで UBM へ紹介報酬のご請求書をお送りください。進捗や疑問点の窓口は AIX 公式LINE に移管しておりますので、ご登録のうえ「事業パートナー（UBM）／氏名」をお送りください。",
    tags: ["紹介報酬", "請求", "入金確認"],
    references: [
      {
        label: "AIX 公式LINE",
